...
class Lesson(object):
    ...
    def earlierTime(self):
        ...
        hour_difference = self._term._duration // 60
        minute_difference = self._term._duration % 60

        new_hour = self._term._hour - hour_difference
        new_min = self._term._minute - minute_difference
